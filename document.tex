...
\title{Navigation in Mobile Robots by Arbitration and Fusion in Behavioral Architectures} % para o abstract
...
\data{2021} % ano automatico

\primeiroassina{Kathya Silvia Collazos Linares}
\segundoassina{César Rafael Claure Torrico}
\terceiroassina{Jorge Luis Roel Ortiz}
