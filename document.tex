...
\title{\MakeUppercase{}} % titulo do trabalho em portugues carai

\autor{Marcelo Gervazoni Carbonera} % autor do trabalho
\cita{Carbonera, Marcelo} % sobrenome (maiusculas), nome do autor do trabalho

\palavraschave{Robótica móvel, Robô de acionamento diferencial, \ldots} %
% palavras-chave do trabalho
\keywords{Mobile Robotics, Differential Drive Robot, } % palavras-chave do
% trabalho em ingles
